;;; jävla tema laddar aldrig. klipper ur detta från
;; /usr/share/emacs/site-lisp/themes/color-theme-library.el
;; några färger verkar inte finnas när jag kollar med rainbow-mode
;; se /usr/local/share/emacs/24.0.50/etc/rgb.txt
...
(defun color-theme-arjen ()
  ...
  (color-theme-install
   '(color-theme-arjen
     ...
     (font-lock-keyword-face ((t (:foreground "light goldenrod yellow"))))
