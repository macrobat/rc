...
(defvar zenburn-bg "#323236")
(defvar zenburn-bg+1 "#4f4f4f")
;; XXX region, (not only instance)
;;(defvar zenburn-bg+2 "#5f5f5f")
;; #597418 vim ^_^              
(defvar zenburn-bg+2 "#51918a")           
...
;; XXX	'(mode-line-inactive ((t (:background "#2e3330" :foreground "#88b090"
	'(mode-line-inactive ((t (:background "#366147" :foreground "#88b090"
				   :box (:color "#2e3330" :line-width 2)))))
...
;;	`(cursor ((t (:background "#aaaaaa" :foreground nil))))
	`(cursor ((t (:background "#cbe021" :foreground nil))))
