...
;; would be nice if these weren't needed:
(require 'paredit)
(require 'cl)
...
(defvar *rainbow-delimiters-faces*
  ...
  `[
    ...
    ,(rainbow-delimiters-face-from-colour "#3040E0")
    ,(rainbow-delimiters-face-from-colour "#DF2020")
    ,(rainbow-delimiters-face-from-colour "#8CD0D3")
    ,(rainbow-delimiters-face-from-colour "#BCCC00")
    ,(rainbow-delimiters-face-from-colour "#E0B0F0")
    ,(rainbow-delimiters-face-from-colour "#0CA300")
    ,(rainbow-delimiters-face-from-colour "#B02000")
    ,(rainbow-delimiters-face-from-colour "#00A3A0")
    ,(rainbow-delimiters-face-from-colour "#CD5710")
    ,(rainbow-delimiters-face-from-colour "#295F3F")
